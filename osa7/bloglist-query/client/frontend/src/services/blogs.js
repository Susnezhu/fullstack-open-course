...
const postComment = async (blogId, comment) => {
  const comments = await axios.post(`${baseUrl}/${blogId}/comments`, {comment})

  return comments.data
}

export default { getAll, getLoggedUser, createNewBlog, likeBlog, deleteBlog, getAllUsers, postComment };
